...
eval("function modalMessage() {\r\n  document.addEventListener('click', (e) => {\r\n    if (!e.target.dataset.modal) return\r\n\r\n    if (checkModal(e.target.dataset.modal)) {\r\n      e.preventDefault()\r\n    }\r\n  })\r\n}\r\nfunction createModal(){\r\n  return `\r\n    <div class=\"modal-message\">\r\n      <div class=\"modal-message__window\"></div>\r\n    </div>\r\n  `\r\n}\r\nfunction checkModal(modalType) {\r\n  if(modalType === 'error') {\r\n    showModal('Не реализовано!')\r\n    return true\r\n  }\r\n}\r\nfunction showModal(msg) {\r\n  const wrapper = document.querySelector('.modal-message')\r\n  const window = wrapper.querySelector('.modal-message__window')\r\n\r\n  wrapper.classList.add('show')\r\n  document.body.style.overflow = 'hidden'\r\n  window.innerText = msg\r\n  closeModal(wrapper)\r\n}\r\nfunction closeModal(modal) {\r\n  modal.addEventListener('click', (e) => {\r\n    if (e.target.classList.contains('modal-message')) {\r\n      modal.classList.remove('show')\r\n      document.body.style.overflow = 'visible'\r\n    }\r\n  })\r\n}\r\nmodalMessage()\r\n\n\n//# sourceURL=webpack:///./src/assets/js/modalMessage.js?");
...
eval("document.body.onload = loader()\r\nfunction loader() {\r\n  let images = document.images\r\n  let images_total_count = images.length\r\n  let images_loader_count = 0\r\n  let preloader = document.querySelector('.header__loader')\r\n  let percLoader = 0\r\n\r\n  for (let i = 0; i < images_total_count; i++) {\r\n    image_clone = new Image()\r\n    image_clone.onload = imageLoader\r\n    image_clone.onerror = imageLoader\r\n    image_clone.src = images[i].src\r\n  }\r\n  function imageLoader() {\r\n    images_loader_count++\r\n    percLoader = (((100 / images_total_count) * images_loader_count) << 0) + '%'\r\n    preloader.style.width = percLoader\r\n    if(images_loader_count>=images_total_count) {\r\n      preloader.style.display = 'none'\r\n    }\r\n  }\r\n}\r\n\r\n\n\n//# sourceURL=webpack:///./src/assets/js/preloader.js?");
